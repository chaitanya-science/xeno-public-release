 ...
 */
export class BasicAudioProcessor implements AudioProcessor {
  private readonly NOISE_GATE_THRESHOLD = 0.01; // Threshold for noise gating
  private readonly NORMALIZATION_TARGET = 0.7; // Target volume level for normalization
   ...
   * Apply simple low-pass filter to reduce high-frequency noise
   */
  private applyLowPassFilter(samples: number[]): void {
