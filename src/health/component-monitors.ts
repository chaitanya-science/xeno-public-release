...
import { ComponentMonitor, ComponentHealth, HealthStatus } from './interfaces';

export class AudioComponentMonitor implements ComponentMonitor {
  name = 'Audio System';
...
export class ConversationComponentMonitor implements ComponentMonitor {
  ...
  private async checkConversationManager(): Promise<boolean> {
    // Placeholder - would check actual conversation manager health
    return true;
  }
}

export class MemoryComponentMonitor implements ComponentMonitor {
  name = 'Memory Manager';
...
export class CrisisComponentMonitor implements ComponentMonitor {
  ...
  private async checkCrisisSystem(): Promise<boolean> {
