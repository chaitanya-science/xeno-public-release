...
class PerformanceAnalyzer {
    async runAnalysis() {
        ...
        const stats = performance_manager_1.performanceManager.getPerformanceStats();
    ...
    displayResponseTimeAnalysis(stats) {
    ...
    async benchmarkSystem() {
        ...
        const newStats = performance_manager_1.performanceManager.getPerformanceStats();
    ...
    async testCachePerformance() {
        ...
        for (let i = 0; i < 10; i++) {
            performance_manager_1.performanceManager.cacheResponse(`test-${i}`, 'context', `response-${i}`);
            performance_manager_1.performanceManager.getCachedResponse(`test-${i}`, 'context');
        }
    }
