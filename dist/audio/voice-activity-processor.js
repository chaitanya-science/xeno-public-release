...
exports.VoiceActivityDetectingProcessor = void 0;
class VoiceActivityDetectingProcessor {
    constructor(config) {
     ...
     */
    calculateVolumeLevel(audioBuffer) {
        let sum = 0;
        let count = 0;
     ...
     */
    calculateSpeechProbability(audioBuffer, volumeLevel) {
     ...
     */
    setThresholds(volumeThreshold, speechThreshold) {
...
exports.VoiceActivityDetectingProcessor = VoiceActivityDetectingProcessor;
//# sourceMappingURL=voice-activity-processor.js.map