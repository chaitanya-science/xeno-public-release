...
exports.demonstrateSpeechToText = demonstrateSpeechToText;
const speech_to_text_factory_1 = require("../speech-to-text-factory");
...
async function demonstrateSpeechToText() {
    ...
    try {
        ...
        const speechService = speech_to_text_factory_1.SpeechToTextFactory.createGoogleSpeechService({
        ...
        const wellnessService = speech_to_text_factory_1.SpeechToTextFactory.createWellnessOptimizedService({
            projectId: process.env.GOOGLE_CLOUD_PROJECT_ID,
            keyFilename: process.env.GOOGLE_CLOUD_KEY_FILE,
        });
        ...
        const audioProcessor = new audio_processor_1.BasicAudioProcessor();
...
//# sourceMappingURL=speech-to-text-demo.js.map