...
exports.VoiceEnabledWellnessCompanion = void 0;
exports.createVoiceEnabledCompanion = createVoiceEnabledCompanion;
const voice_assistant_manager_1 = require("../voice/voice-assistant-manager");
const speech_to_text_service_1 = require("../audio/speech-to-text-service");
const google_text_to_speech_service_1 = require("../audio/google-text-to-speech-service");
const conversation_manager_1 = require("../conversation/conversation-manager");
const conversation_flow_1 = require("../conversation/conversation-flow");
const response_router_1 = require("../conversation/response-router");
const config_manager_1 = require("../config/config-manager");
const types_1 = require("../types");
class VoiceEnabledWellnessCompanion {
    constructor() {
        this.voiceAssistant = null;
        this.configManager = new config_manager_1.DefaultConfigManager();
    }
    async initialize() {
        // Load configuration
        ...
        const speechToTextService = new speech_to_text_service_1.GoogleSpeechToTextService(config.ai.speechServices.projectId || 'default-project', config.ai.speechServices.apiKey);
        const textToSpeechService = new google_text_to_speech_service_1.GoogleTextToSpeechService({
            provider: 'google',
            apiKey: config.ai.speechServices.apiKey,
            defaultVoice: 'en-US-Neural2-F', // Athena's calm, soft female voice
        ...
        const responseRouter = new response_router_1.ResponseRouter(conversationFlow);
        const conversationManager = new conversation_manager_1.CoreConversationManager(conversationFlow, responseRouter, {
            ...
            privacyLevel: config.privacy.allowConversationHistory ? types_1.PrivacyLevel.HIGH : types_1.PrivacyLevel.LOW
        });
        // Create voice assistant with optimal settings
        this.voiceAssistant = new voice_assistant_manager_1.VoiceAssistantManager(speechToTextService, textToSpeechService, conversationManager, {
...
exports.VoiceEnabledWellnessCompanion = VoiceEnabledWellnessCompanion;
// Usage example
...
//# sourceMappingURL=voice-wellness-integration.js.map